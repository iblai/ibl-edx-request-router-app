...
MANAGER_API_UNAUTH_ALLOWLIST = getattr(settings, 'IBL_REQUEST_ROUTER_MANAGER_API_UNAUTH_ALLOWLIST', [])
MANAGER_API_AUTH_ALLOWLIST = getattr(settings, 'IBL_REQUEST_ROUTER_MANAGER_API_AUTH_ALLOWLIST', [])

URL_PATTERNS_BEFORE_ROUTER = getattr(
    settings, 'IBL_URL_PATTERNS_BEFORE_ROUTER', []
)
